...
public class FormUtil {
	private static HashMap<Component, Color> compBG;
	...
	private static void clear(Component comp) {
		...
		} else if (className.equals("javax.swing.JPasswordField")
				|| nombre_super.equals("javax.swing.JPasswordField")) {
			((javax.swing.JPasswordField) comp).setText("");
		} else if (className.equals("javax.swing.JFormattedTextField")
				|| nombre_super.equals("javax.swing.JFormattedTextField")) {
	...
	public static void requiredFieldWarning(Component comp) {
		comp.requestFocus();
		if (compBG == null) compBG = new HashMap<Component, Color>();
		if (compBG.get(comp) == null) compBG.put(comp, comp.getBackground());
		comp.setBackground(Color.RED);
		int delay = 500;
		ActionListener taskPerformer = new ActionListener() {
			public void actionPerformed(ActionEvent evt) {
				comp.setBackground(compBG.get(comp));
				compBG.remove(comp);
				timer.stop();
			}
		};
